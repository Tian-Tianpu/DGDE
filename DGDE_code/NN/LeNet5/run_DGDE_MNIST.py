            ...
            for subset_size in Sub_Size:
                for K_0 in K_0s:
                    ...
                    (train_dataset, val_dataset, test_dataset,
                     trainloader, valloader, testloader, num_classes) = choose_dataset_subset(dataname, batch_size,
                                                                                              subset_size)
                    ...
                    # 初始化种群
                    population = [create_grayscale_model(model_name, num_classes).to(device) for _ in
