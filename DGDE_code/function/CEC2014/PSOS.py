...
class OriginalPSO(Optimizer):
    ...
    def __init__(self, epoch: int = 10000, pop_size: int = 100, c1: float = 2.05, c2: float = 2.05, w: float = 0.4,
        ...
        # Lists to store the best fitness values
        self.epoch_best_fitness = []  # Best fitness in each epoch
        self.global_best_fitness = []  # Global best fitness over all epochs
    ...
    def get_epoch_best_fitness(self):
        return self.epoch_best_fitness
    ...
    def evolve(self, epoch):
        ...
        # Save the best fitness of the current epoch
        current_epoch_best_fitness = self.get_best_agent(self.pop, self.problem.minmax).target.fitness
        self.epoch_best_fitness.append(current_epoch_best_fitness)

        # Save the global best fitness
        self.global_best_fitness.append(self.g_best.target.fitness)
