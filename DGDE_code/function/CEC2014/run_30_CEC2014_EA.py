...
import os
from all_function_cec2014 import select_function
...
#=================================================================
for dimension in Dimension:
    for function_name in range(20, 31):
        print("-------------Running-" + str(dimension) + "D-Func" + str(function_name) + "-------------")
        figure_save_path = ("./results_CEC2022_repeats/"+ "0lr_0F0/" +  "Func_"+ str(function_name) + "_" +str(dimension) + "D/"
                                    )
        objective_function, gradient_function, x_min, x_max = select_function(function_name, dimension)
